...
public class ResearchHelper extends ResearchItem {
    ...
    public String getText() {
            return StatCollector.translateToLocal("[" + ThaumcraftExtras.alias + "] ") + StatCollector.translateToLocal(ThaumcraftExtras.alias.toLowerCase() + ".tag." + key);
    }
    ...
    public ResearchItem setPages(ResearchPage... par) {
            for(ResearchPage page : par) {
                    if(page.type == PageType.TEXT)
                            page.text = ThaumcraftExtras.alias.toLowerCase() + ".text." + key + "." + page.text;
