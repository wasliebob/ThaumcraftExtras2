...
public class RenderNoMove extends BlockRenderer implements ISimpleBlockRenderingHandler{
	...
	public void renderInventoryBlock(Block block, int metadata, int modelId,
		...
		TileEntityRendererDispatcher.instance.renderTileEntityAt(new TileEntityNoMove(), 0.0D, 0.0D, 0.0D, 0.0F);
		GL11.glPopMatrix();
	}
